(function($){
    ...
    (function handlerTrailer(){
        ...
        /*
        //보이기, 숨기비 버튼 활성화
        $selector.showButton.click("click", showPlayer);
        $selector.hideButton.click(hidePlayer);
        */
        ...
        function resizePlayer(){
            ...
            frame.height = frame.width / 1.6; //화면비율 16 : 10
